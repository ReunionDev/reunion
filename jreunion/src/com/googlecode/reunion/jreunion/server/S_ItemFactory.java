...
public class S_ItemFactory {
	...
	public static  G_Item createItem(int type)
	{
		...
		S_ParsedItem parseditem = S_Reference.getInstance().getItemReference().getItemById(type);
		if (parseditem==null)
		{
			return null;	
		}
	...
	public static  G_Item loadItem(int id)
	{
		...
		G_Item item=null;
			...
			com.googlecode.reunion.jreunion.game.G_EntityManager.getEntityManager().loadEntity(item,id);
