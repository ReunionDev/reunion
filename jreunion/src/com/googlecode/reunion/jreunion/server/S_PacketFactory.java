	...
	public static String createPacket(int packettype,Object... arg)
	{
		...
		case PT_VERSION_ERROR:
		{
			if (arg.length==1)
			{
				...
				String requiredVersion = String.valueOf(S_DatabaseUtils.getInstance().getVersion());
				return "fail Wrong clientversion: current version " + clientVersion + " required version "+ requiredVersion + "\n";
			}
