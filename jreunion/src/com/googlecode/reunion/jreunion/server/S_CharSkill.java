...
public class S_CharSkill {
	...
	public void loadSkillList(int race){
		switch(race){
			case 0: { addSkill(new G_Skill(1));
					  ...
					  addSkill(new G_Skill(75));break;}
			case 1: { addSkill(new G_Skill(3));
			  		  ...
			  		  addSkill(new G_Skill(76));break;}
			case 2: { addSkill(new G_Skill(6)); 
					  ...
					  addSkill(new G_Skill(32));
			  		  ...
			  		  addSkill(new G_Skill(78));break;}
			case 3: { addSkill(new G_Skill(20));
	  		  		  ...
	  		  		  addSkill(new G_Skill(77));break;}
			case 4: { addSkill(new G_Skill(79));
	...
	public void setSkill(G_Player player, G_Skill skill) {
		...
		if(skill.getCurrLevel() == 1){
			...
			float incFirstRange = (float)(skill.getCurrLevel()-1)*(float)(skill.getMaxFirstRange()-skill.getMinFirstRange())/(float)skill.getMaxLevel();
			skill.setCurrFirstRange(Math.round(skill.getMinFirstRange() + incFirstRange));
			
			float incSecondRange = (float)(skill.getCurrLevel()-1)*(float)(skill.getMaxSecondRange()-skill.getMinSecondRange())/(float)skill.getMaxLevel();
			skill.setCurrSecondRange(Math.round(skill.getMinSecondRange() + incSecondRange));
						
			float incConsumn = (float)(skill.getCurrLevel()-1)*(float)(skill.getMaxConsumn()-skill.getMinConsumn())/(float)skill.getMaxLevel();
